...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorLocalNotifications", path: "..\..\..\node_modules\.pnpm\@capacitor+local-notifications@8.2.1_@capacitor+core@8.5.0\node_modules\@capacitor\local-notifications"),
